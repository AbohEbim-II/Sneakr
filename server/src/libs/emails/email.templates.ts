...
<body>
  <div class="wrapper">
    <div class="header">
      <h1>Sneakr</h1>
      <p>Your number one online sneaker marketplace</p>
    </div>
    <div class="body">${content}</div>
    <div class="footer">
      <p>This is an automated message from Sneakr. Please do not reply to this email.<br/>
...
export const welcomeEmail = (data: WelcomeEmailData) => ({
    subject: `Welcome to Sneakr, ${data.recipientName}!`,
    html: wrap(`
    ...
    <a href="${data.loginUrl}" class="btn" style="background: #1a1a2e;">Log In</a>
    <div class="divider"></div>
    <p style="font-size: 13px; color: #999;">If you did not create this account, you can safely ignore this email.</p>
  `),
});
...
export const passwordResetEmail = (data: PasswordResetEmailData) => ({
    subject: "Reset your Sneakr password",
    html: wrap(`
    <h2>Password Reset Request</h2>
    <p>Hi <strong>${data.recipientName}</strong>, we received a request to reset your password.</p>
    ...
    <div class="divider"></div>
    <p style="font-size: 13px; color: #999;">If you did not request a password reset, you can safely ignore this email. Your password will not change.</p>
  `),
});
...
export const passwordChangedEmail = (data: PasswordChangedEmailData) => ({
    subject: "Your Sneakr password was changed",
    html: wrap(`
